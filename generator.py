...
##                    print "\n"
                    ...
                    #include in results
                        if len(str(genome_record.ALT)) - \
                            len(str(genome_record.REF)) == 2 and \
                            len(str(genome_record.REF)) - \
                            len(str(clin_record.REF)) \
                            == len(str(genome_record.ALT)) - \
                            len(str(clin_record.ALT)):
